...
En "Releases" o en este [enlace](https://github.com/slayaglez/Mecanografico/releases/tag/v1.0.4) puedes escoger el instalador para tu sistema operativo. Las descargas, respectivamente, son las siguientes:
